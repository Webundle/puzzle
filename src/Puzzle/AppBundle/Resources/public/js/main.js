...
function windowLoadInit() {
	...
	if (jQuery().countdown)
	{
		...
		var getActualAgendaDate;
		var getActualAgendaTitleFr;
		var getActualAgendaTitleAng;
		var getActualAgendaLieuFr;
		var getActualAgendaLieuAng;
		var getActualAgendaPeriodeFr;
		var getActualAgendaPeriodeAng;
		var getActualAgendaLogo;
		...
		$.ajax({
			...
			{
				//console.log(data);
				getActualAgendaDate=data[0].dateagenda;
				getActualAgendaTitleFr=data[0].titre;
				getActualAgendaTitleAng=data[0].titreen;
				getActualAgendaLieuFr=data[0].lieufr;
				getActualAgendaLieuAng=data[0].lieuen;
				getActualAgendaPeriodeFr=data[0].periodefr;
				getActualAgendaPeriodeAng=data[0].periodeen;
				getActualAgendaLogo=data[0].logo;
				
				title.append(getActualAgendaTitleFr);
				titleen.append(getActualAgendaTitleAng);
				
				periode.append(getActualAgendaPeriodeFr);
				periodeen.append(getActualAgendaPeriodeAng);
				
				lieu.append(getActualAgendaLieuFr);
				lieuen.append(getActualAgendaLieuAng);
				
				console.log(getActualAgendaDate);
				//console.log(getActualAgenda[0].id);
				
				var demoDate = new Date();
				demoDate.setMonth(demoDate.getMonth()+1);
				//console.log(" dscoksodc "+demoDate);
				var demoENSEA=new Date(getActualAgendaDate);
				console.log(demoENSEA);
				$("#eventimage").html("<img style='' src='/assets/images/ENSEA/"+getActualAgendaLogo+"'/>");
				console.log(getActualAgendaLogo);
				jQuery('#comingsoon-countdown').countdown({
					//until: demoDate,
					until: demoENSEA,
					labels: ['Yr', 'Mo', 'Wk', 'JOURS', 'HEURES', 'MINUTES', 'SECONDES'],
		...
		demoDate.setMonth(demoDate.getMonth()+1);
		console.log(" dscoksodc "+demoDate);
		var demoENSEA=new Date();
		console.log("OKOKO "+demoENSEA);
		jQuery('#comingsoon-countdown').countdown({
			//until: demoDate,
			until: getActualAgenda,
	...
	jQuery('form.contact-form').on('submitsss', function( e ){
		e.preventDefault();
	...
	jQuery('.signup').on('submit', function( e ) {
		e.preventDefault();
		var $form = jQuery(this);
        var $submit = $('#btn-submit-subscriber'); 
        var $contentBtn = $submit.html();
        $submit.html('<i class="fa fa-spinner spin"></i>');
